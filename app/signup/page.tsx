        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full mt-1 pr-10 px-3 py-2 rounded-xl bg-white/50 dark:bg-zinc-900/50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-fuchsia-400/60 shadow-sm"
              placeholder="••••••••"
            />
            <button
              type="button"
